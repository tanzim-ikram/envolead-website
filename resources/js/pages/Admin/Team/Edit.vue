...
const form = useForm({
    ...
    other_designations: props.member?.other_designations || '',
...
const submit = () => {
    ...
    if (form.other_designations !== props.member.other_designations) changedData.other_designations = form.other_designations;
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-center">
                                    <div
                                        ...
                                        <img v-if="previewUrl" :src="previewUrl" :alt="props.member.name"
