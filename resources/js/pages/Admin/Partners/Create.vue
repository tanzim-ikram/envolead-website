...
const submit = () => {
    form.post(route('admin.partners.store'), { forceFormData: true });
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Add Partner</h1>
                    <p class="text-gray-600 mt-1">Fill in details to create a new partner</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border-2 border-gray-200 p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select v-model="form.type" class="w-full px-4 py-2 border-2 border-gray-300 rounded-md focus:border-green-500 focus:outline-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div
                                class="w-24 h-24 border-2 border-gray-300 rounded overflow-hidden bg-gray-50 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <label for="logo-upload"
                                    ...
                                    <Upload class="w-4 h-4 mr-2" /> Upload Logo
                                </label>
